...
The sound engine is developed in RNBO (https://rnbo.cycling74.com/). You can find the patches in RNBO.Max patches folder.
The web architecture is developed in JavaScript and built on **soundworks**. To use the app, here follows the instructions for the correct operation of a **soundworks** application. 
